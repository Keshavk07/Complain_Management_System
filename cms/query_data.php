...
.affix {
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li ><a href="myform.php" id = "li">Add Complaint</a></li>
      <li><a href="logoutform.php" id = "li">Checked Out Complaints</a></li>
	...
	<div id='body'>
		...
		<div class="FormLabel" style="border-top: solid 2px;">		
		 ...
		 <div class="FormLabel" style="border-top: solid 2px;">
		 <label for =" active entries">View all Active Complaints : </label><input type = "radio" name = "search"  id="active" value ="active" onclick="disable()">
		 </div>
...
function echoDetails($row){
   ...
   echo '<div class="col-sm-2">
             <div class="thumbnail" style = "width:175px;">
	           ...
	           <p>Complaint To : '.$result['meetingTo'].'</p>
	        </div>
	       </div>';
	   }
  }         
