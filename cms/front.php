<?php  include('db_connect_db_new.php');
   ...
   $resultToday = mysqli_num_rows(mysqli_query($link,$sql));   //recent Complaints
   $resultS = mysqli_query($link,$sqlOnline);       //Online Complaints
...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#" id = "lii"><span  >COMPLAINT MANAGEMENT</span></a>
    </div>
    <ul class="nav navbar-nav navbar-right">
      <li class="active"><a  href="front.php">Home</a></li>
      <li><a id = "li" href="myform.php" >Add Complaint</a></li>
...
<div class="col-sm-3" style="padding-left:50px;height:100%;"> 
 ...
 <div><h3>Check Out Complaints</h3></div>
...
<h3 style="margin-right:auto;padding-left:40px;">Recent Complaints :&nbsp;<?php echo $onlineVsitor;?></h3>
