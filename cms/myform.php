...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="active"><a  href="myform.php">Add Complaint</a></li>
      <li ><a  id = "li" href="logoutform.php">Checked Out Complaints</a></li>
...
<div style="margin-left:110px;padding-bottom:12px">
  ...
  <input autocomplete="off" class="form-control" type= "text" name ="name" placeholder= "Enter Name." required id = "name"
...
<label for ="prps">Complaint :</label> 
<input autocomplete="off" class="form-control" type="text" name="purpose" placeholder="Enter Your Complaint." required id = "Purpose" 
...
<div class="row">
 <div class="col-sm-7">
  <div class="form-group">
   <label for = "meetingTo">Complaint to :</label>
    <input autocomplete="off" class="form-control" type="text" required name = "MeetingTo" id = "meetingTo" 
	   placeholder="Whom will you complaint ?"       oninvalid="this.setCustomValidity(this.willValidate?'':'Whom do you want to meet ?')" maxlength="30"  onblur="isEmpty('meetingTo')"
	   data-toggle="popover" title="Popover Header" data-content="Some content inside the popover" data-trigger = "onfocus"/>
   </div>
  </div>
