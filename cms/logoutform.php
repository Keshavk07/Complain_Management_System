...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="active"><a href="logoutform.php">Checked Out Complaints</a></li>
...
<div>
  <p ><h3 style = "padding-left: 25px">These Complaints were Cleared out Today!</h3></p><br>
...
$res = mysqli_query( $link,$query);
      ...
      while($result = mysqli_fetch_array($res, MYSQLI_ASSOC))
       ...
       <div class="thumbnail" style = "width:175px;">
          ...
          <p>Complaints To : '.$result['meetingTo'].'</p>
